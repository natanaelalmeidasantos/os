                        ...
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="span12" id="divCadastrarOs">
                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    &nbsp&nbsp Digite o inicio do nome do cliente e do Técnico/responsável e aguarde alguns segundos para demostrar os existentes no sistema
                                    <div class="span12" style="padding: 1%">
                                        ...
                                        <div class="span6">
                                            <label for="tecnico">Responsável (Usuario do sistema)<span class="required">*</span></label>
