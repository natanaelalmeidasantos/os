...
<head>
        <title>Sistema O.S</title><meta charset="UTF-8" />
    ...
    <body>
        <div id="loginbox">            
            <form  class="form-vertical" id="formLogin" method="post" action="<?php echo base_url()?>index.php/mapos/verificarLogin">
                ...
                <div class="form-actions" style="text-align: center">
                    ...
                    <button id="btn-acessar" class="btn btn-success btn-large"/> Entrar</button>
                </div>
            </form>
        ...
        <div id="notification" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          ...
          <div class="modal-body">
            <h5 style="text-align: center">Login ou senha incorreto, verifique !</h5>
          </div>
