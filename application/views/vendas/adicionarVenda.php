                        ...
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="span12" id="divCadastrarOs">
                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formVendas">
                                            &nbsp Digite o inicio do nome do cliente/vendedor e aguarde alguns segundos para demostrar os existentes no sistema
                                    ...
                                    <div class="span12" style="padding: 1%">
                                        ...
                                        <div class="span5">
                                            <label for="tecnico">Vendedor (Usuario do sistema)<span class="required">*</span></label>
